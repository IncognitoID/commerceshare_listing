<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="suppliersetuplist.aspx.cs" Inherits="suppliersetuplist" %>
...
<%--            <asp:LinkButton ID="btn_Add" runat="server" OnClick="btn_New_Click " style="float:right;"><i class="glyphicon fa-2x glyphicon-plus-sign addItem" style="color: #4c8262"></i></asp:LinkButton>--%>
                <div style="padding-bottom: 10px; height: 50px; margin-top: 10px;">
                    <h2 style="font-size: x-large; font-weight: bold; margin-top: 13px; margin-bottom: 0px; width: 40%; float: left;">Supplier Listing</h2>
                <asp:TextBox ID="txt_Search" runat="server" AutoComplete="off" MaxLength="50" placeholder="Filter by Supplier code / description" AutoPostBack="true" OnTextChanged="txt_Search_TextChanged" CssClass="col-md-5 col-sm-5 txt_Search" style="display: inline-block;font-weight: bold;padding: 8px; padding-left: 35px; text-align: left;outline: none;text-decoration: none;float:right;"></asp:TextBox>
                <br /><br /><br />
                    </div>
                ...
                <asp:GridView ID="grd_View" ShowFooter="false" runat="server" AutoGenerateColumns="False" DataKeyNames="Supplier_Code"
                    ...
                    <Columns>
                            ...
                            <ItemTemplate>               
                                <div class="dropdown">                  
                                    <p class="dropdown-toggle" data-toggle="dropdown">                 
                                        <a class="glyphicon glyphicon-option-vertical"                           
                                            style="font-size:20pt;cursor:pointer; text-decoration:none;"></a>                  
                                        </p>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>                         
                                          <asp:LinkButton ID="lnkEdit" runat="server" 
                                              Text="Edit"
                                              CommandArgument='<%# Eval("Supplier_Code") %>'
                                              CommandName = "edit">
                                          </asp:LinkButton>
                                        ...
                                        <li>
                                            ...
                                            <asp:LinkButton ID="lnkdel" Text="Delete" runat="server"                               
                                                CommandArgument='<%# Eval("Supplier_Code") %>' CommandName="del"                              
                                                OnClientClick="Confirm()"></asp:LinkButton>                 
                                        </li>                    
                                    </ul>                
                                </div>
                        ...
                        <asp:TemplateField HeaderText="Supplier">            
                            ...
                            <ItemTemplate>                
                                <asp:Label ID="lblSupplierCode" runat="server" Font-Bold="true" 
                           Text='<%# Eval("Supplier_Code") %>'></asp:Label><br />                
                        ...
                        <asp:BoundField DataField="Created_Dt" HeaderText="Created Date" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />      
                        <asp:BoundField DataField="Modified_Dt" HeaderText="Modified Date" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
