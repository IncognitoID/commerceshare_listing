<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ItemGroupingListing.aspx.cs" Inherits="ItemGroupingListing" %>
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <asp:Label ID="lblCatID" runat="server" Visible="false"></asp:Label>
                ...
                <h2 style="font-size: x-large; font-weight: bold; margin-top: 13px; margin-bottom: 0px; width: 40%; float: left;">Grouping Listing</h2>
                <asp:TextBox ID="txt_Search" runat="server" AutoComplete="off" MaxLength="50" placeholder="Filter by Grouping Title"  AutoPostBack="true" OnTextChanged="txt_Search_TextChanged" CssClass="col-md-5 col-sm-5 txt_Search" style="display: inline-block;font-weight: bold;padding: 8px; padding-left:35px; text-align: left;outline: none;text-decoration: none; float:right"></asp:TextBox>
                <br />
                   </div>
<%--                <asp:LinkButton ID="btn_Add" runat="server" OnClick="btn_New_Click" style="float:right;"><i class="glyphicon fa-2x glyphicon-plus-sign addItem" style="color: #4c8262"></i></asp:LinkButton>--%>
                ...
                <asp:GridView ID="grd_View" ShowFooter="false" runat="server" AutoGenerateColumns="False" DataKeyNames="ids"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Grouping Title" SortExpression="grouptitle">
                            <ItemTemplate>
                               <asp:Label ID="lblgrouptitle" runat="server" style="font-weight:bold" Text='<%# Eval("grouptitle") %>'></asp:Label>
                               <br />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="active" HeaderText="Active Item" SortExpression="active" />
                        <asp:BoundField DataField="inactive" HeaderText="Inactive Item" SortExpression="inactive"/>
                    </Columns>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width:auto">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="font-size:large;  color:black;font-weight:bold">Add Item Group   <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button></h5>
                  
                </div>
                <div class="modal-body flex-container">
                    <label class="col-sm-3 control-label col-lg-4">Group Title</label>
                    <div class="form-group col-sm-9">
                        <input ID="txt_Grouptitle" runat="server" placeholder="" class="col-md-12 col-xs-12" style="border: 2; height: 34px; padding: 6px 12px; font-size: 14px;"/>
<%--                        <asp:RequiredFieldValidator EnableClientScript="true" ID="RequiredFieldValidator2" runat="server" ValidationGroup="modal" ControlToValidate="txt_Grouptitle" ErrorMessage="Text box cannot be empty!" Display="Dynamic" />--%>
                    </div>
                </div>
