<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DepartmentSetupList.aspx.cs" Inherits="DepartmentSetupList" %>
...
<%--            <asp:LinkButton ID="btn_Add" runat="server" OnClick="btn_New_Click " style="float:right;"><i class="glyphicon fa-2x glyphicon-plus-sign addItem" style="color: #4c8262"></i></asp:LinkButton>--%>
                <div style="padding-bottom: 10px; height: 50px; margin-top: 10px;">
                    <h2 style="font-size: x-large; font-weight: bold; margin-top: 13px; margin-bottom: 0px; width: 40%; float: left;">Department Listing</h2>
                <asp:TextBox ID="txt_Search" runat="server" AutoComplete="off" MaxLength="50" placeholder="Filter by department code / description" AutoPostBack="true" OnTextChanged="txt_Search_TextChanged" CssClass="col-md-5 col-sm-5 txt_Search" style="display: inline-block;font-weight: bold;padding: 8px; padding-left: 35px; text-align: left;outline: none;text-decoration: none;float:right;"></asp:TextBox>
                <br /><br /><br />
                    </div>
                ...
                <asp:GridView ID="grd_View" ShowFooter="false" runat="server" AutoGenerateColumns="False" DataKeyNames="Department_ID"
                    ...
                    <Columns>
                            ...
                            <ItemTemplate>
                                 <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><asp:LinkButton ID="lnkedit" Text="Edit" runat="server" CommandArgument='<%# Eval("Department_ID") %>' CommandName="edit"></asp:LinkButton></li>
                                            <li><asp:LinkButton ID="lnkdel" Text="Delete" runat="server" CommandArgument='<%# Eval("Department_Code") %>' CommandName="del" OnClientClick="Confirm()"></asp:LinkButton></li>
                                        </ul>
                                     </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Department">
                            ...
                            <ItemTemplate>
                               <asp:Label ID="lblDeptCode" runat="server" Font-Bold="true" Text='<%# Eval("Department_Code") %>'></asp:Label>
                               <br />
                               <asp:Label ID="lblDeptDesc" runat="server" Text='<%# Eval("Department_Description") %>'></asp:Label>
                               <br />
                            </ItemTemplate>
                        </asp:TemplateField>
